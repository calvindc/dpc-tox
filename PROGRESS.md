...
DONE tox_callback_group_invite
DONE tox_callback_group_message
DONE tox_callback_group_action
DONE tox_callback_group_title
DONE tox_callback_group_namelist_change
DONE tox_add_groupchat
DONE tox_del_groupchat
DONE tox_group_peername
DONE tox_group_peer_pubkey
DONE tox_invite_friend
DONE tox_join_groupchat
DONE tox_group_message_send
DONE tox_group_action_send
DONE tox_group_set_title
DONE tox_group_get_title
DONE tox_group_peernumber_is_ours
DONE tox_group_number_peers
DONE tox_group_get_names
DONE tox_count_chatlist
DONE tox_get_chatlist
DONE tox_group_get_type
```
